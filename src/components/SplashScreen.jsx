...
// רק האנימציה, ואז פייד-אאוט למסך הפתיחה

import { useEffect, useState } from "react";

// הלוגו מחולק: הקשת למעלה + רגל שמאל בנפרד לאנימציה
const LogoStatic = ({ size = 180 }) => (
...
export default function SplashScreen({ onDone }) {
  ...
  return (
    <>
      <style>{`
        @keyframes left-leg-stretch {
          /* עמידה שקטה */
          0%   { transform: none; }
          8%   { transform: none; }

          /* הרגל השמאלית מתחילה להימתח לאט */
          /* transform-origin: top right — הצד הימני קבוע, שמאל נמתך */
          30%  { transform: rotate(-4deg) scaleY(1.14) translateY(3px); }

          /* שיא המתיחה */
          52%  { transform: rotate(-7deg) scaleY(1.22) translateY(6px); }

          /* חוזרת לאט — כמו מישהו שמוריד את הרגל */
          78%  { transform: rotate(-2deg) scaleY(1.05) translateY(1px); }
        ...
        .leg-anim {
          ...
          animation: left-leg-stretch 3.2s cubic-bezier(0.45, 0.05, 0.55, 0.95) 1 forwards;
        }
      `}</style>
